...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bs_XJpsi_ee.dec')
        ),
...
ProductionFilterSequence = cms.Sequence(generator*bsfilter*decayfilterpositiveleg*jpsifilter*mufilter)
