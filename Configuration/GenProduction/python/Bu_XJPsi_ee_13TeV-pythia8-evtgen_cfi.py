...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bu_XJpsi_ee.dec')
        ),
...
decayfilterpositiveleg = cms.EDFilter(
    ...
    ParticleID      = cms.untracked.int32(521),  ## Bu
    DaughterIDs     = cms.untracked.vint32(443), ## Psi(2S) and K+
...
ProductionFilterSequence = cms.Sequence(generator*bufilter*decayfilterpositiveleg*jpsifilter*mufilter)
