...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bu_D0Pi_henuPi.dec')
        ),
...
d0filter = cms.EDFilter("PythiaDauVFilter",
    DaughterIDs = cms.untracked.vint32(-321, -211, -11, 12), # K- or pi- e+ nu_e
    MaxEta = cms.untracked.vdouble(9999.0, 9999.0, 9999.0, 9999.0),
    MinEta = cms.untracked.vdouble(-9999.0, -9999.0, -9999.0, -9999.0),
    MinPt = cms.untracked.vdouble(-1.,-1., -1.,-1.),
