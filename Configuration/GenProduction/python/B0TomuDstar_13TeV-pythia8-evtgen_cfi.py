...
decayfilter = cms.EDFilter(
    ...
    DaughterIDs     = cms.untracked.vint32(413, 13), ## D*+ and mu-
...
mu2filter = cms.EDFilter("MCMultiParticleFilter",
...
ProductionFilterSequence = cms.Sequence(generator*bfilter*decayfilter*dstarfilter*d0filter*mu2filter*mufilter)
