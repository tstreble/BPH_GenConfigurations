...
mufilterPt7 = cms.EDFilter("PythiaFilter",  # bachelor muon with kinematic cuts.
...
ProductionFilterSequence = cms.Sequence(generator*decayfilter*mufilter*mufilterPt7)
